...
% ****************************************************************************************************
\newcommand{\myTitle}{Pedestal Structure and Stability in High-Performance Plasmas on Alcator C-Mod\xspace}
\newcommand{\myDegree}{Doctor of Science\xspace}
\newcommand{\myName}{John Walk\xspace}
\newcommand{\myDepartment}{Department of Nuclear Science \& Engineering\xspace}

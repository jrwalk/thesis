...
While historically a number of models for the pedestal width (see \cref{sec:mod_empirical}) have been examined, the most uniformly successful has been an expected scaling of $\Delta \sim \beta_{p,ped}^{1/2}$ derived from a critical-gradient limit driven by kinetic-ballooning mode (KBM) instabilities\gnote{cites!!}.

...
\begin{equation}\label{eq:dW_balloon_current}
  \pi \iint d\psi d\chi \left\{ - \frac{X^*}{n} JB k_\parallel \left( X \frac{d \sigma}{d \psi} \right) + \frac{1}{n} \left[ P^* JB k_\parallel Q + PJBk_\parallel^* Q^* \right] \right\}
\end{equation}
...
\begin{figure}[ht]
 \pushtooutside
 \ffigbox[\FBwidth]{\includegraphics[width=150mm]{graphics/ModelingTheory/eped_old.pdf}}{\caption[EPED predictions versus measured pedestal height and width.]{EPED1 predictions versus measured pressure pedestal height and width on a range of DIII-D discharges \cite{Snyder2009}. \note{permission}}\label{fig:mod_epedpredictions}}
\end{figure}

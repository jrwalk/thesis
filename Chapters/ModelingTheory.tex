...
\noindent normal to the flux surface and geodesic within the flux surface, respectively.\gnote{clarify further?}
...
\noindent where $\gamma_{MHD}$ is the ideal growth rate and $\omega_{*pi}$ is the diamagnetic frequency given by \cite{Snyder2009,Huysmans2001}.\gnote{quoted from Huysmans, point to Dennis}
...
\begin{figure}
 \pushtooutside
 \fcapside[60mm]{\caption[Schematic of peeling-ballooning MHD stability space.]{Schematic of the stability space to coupled peeling-ballooning MHD modes, set by the edge pressure gradient and current density.  Ballooning modes are driven by pressure gradient, while kink/peeling modes are current-driven but stabilized by pressure gradients.}\label{fig:mod_pbcartoon}}{\includegraphics[width=100mm]{graphics/ModelingTheory/pbcartoon.pdf}}
\end{figure}
...
\begin{figure}[ht]
 \pushtooutside
 \ffigbox[\FBwidth]{\includegraphics[width=150mm]{graphics/ModelingTheory/eped_old.pdf}}{\caption[EPED predictions versus measured pedestal height and width.]{EPED1 predictions versus measured pressure pedestal height and width on a range of DIII-D discharges \cite{Snyder2009}.}\label{fig:mod_epedpredictions}}
\end{figure}

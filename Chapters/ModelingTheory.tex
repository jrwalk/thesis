...
\begin{figure}[ht]
 \pushtooutside
 \ffigbox[\FBwidth]{\includegraphics[width=150mm]{graphics/ModelingTheory/eped_old.pdf}}{\caption[EPED predictions vs. measured pedestal height and width.]{EPED1 predictions versus measured pressure pedestal height and width on a range of DIII-D discharges \cite{Snyder2009}.}\label{fig:mod_epedpredictions}}
\end{figure}

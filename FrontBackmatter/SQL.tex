...
\newcolumntype{a}{>{\hsize=0.27\hsize\raggedright\arraybackslash}X}
\newcolumntype{b}{>{\hsize=0.115\hsize\centering\arraybackslash}X}
\newcolumntype{c}{>{\hsize=0.5\hsize\centering\arraybackslash}X}
\begin{table*}[h]
 \pushtooutside

...
\newcolumntype{a}{>{\hsize=0.23\hsize\raggedright\arraybackslash}X}
\newcolumntype{b}{>{\hsize=0.11\hsize\centering\arraybackslash}X}
\newcolumntype{c}{>{\hsize=0.55\hsize\centering\arraybackslash}X}
\begin{table*}[h]
 \pushtooutside

...
The scattered photons are focused through a Cooke triplet mounted at an outboard-midplane access port onto an array of fiber-optic collectors mounted on an actuated plate (see \cref{fig:app_ts_optics}).  Dedicated edge-viewing fibers are mounted in an adjustable block at the base of the plate, viewing the upper plasma at a scattering angle of $\theta \sim \SI{80}{\degree}$.  

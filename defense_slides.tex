...
\begin{frame}
 ...
 ELITE solves this by encoding the poloidal angle $\chi$ in a straight-line coordinate via the ``ballooning transform,''
...
\begin{frame}
 ...
 Euler-Lagrange equation minimizing the energy may be expressed in this harmonic expansion by a set of coupled equations\footnote[6]{HR Wilson \emph{et al.}, \emph{Physics of Plasmas} \textbf{9} (2002)}

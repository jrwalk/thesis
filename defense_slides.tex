...
\begin{frame}{...But this has problems of its own}
 ...
 \begin{columns}[c]
  ...
  \column{0.5\textwidth}
  \centering
  \includegraphics[width=0.85\columnwidth]{graphics/HighPerformanceRegimes/trace_1110114003_v2.pdf}
 \end{columns}
...
\begin{frame}{A challenger appears: the I-mode}
 ...
 \large
 \begin{itemize}
  \item novel high-confinement regime pioneered on Alcator C-Mod, occupying intermediate parameter space between L-mode and H-mode access
  \vspace{0.5em}
...
\begin{frame}{Kinetic-ballooning mode (KBM) turbulence limits\\ pressure gradient in pedestal}
 ...
 \begin{itemize}
  ...
  \vspace{0.5em}
  \item onset threshold correlated with infinite-$n$ ideal ballooning MHD mode -- easily calculation nearly as accurate as more involved gyrokinetic+gyrofluid turbulence treatments
 \end{itemize}

...
\only<2->{\begin{itemize}
 \large
 \item \textbf{I-Mode Pedestals \& Global Performance}\footnote{JR Walk \emph{et al.}, \emph{Physics of Plasmas} \textbf{21} (2014)}$^,$\footnote{\emph{Invited talk}, APS-DPP Nov. 2013}
 \begin{itemize}
  \large

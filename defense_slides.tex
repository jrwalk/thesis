...
\begin{frame}{Need to understand I-mode pedestals}

 \large
 I-mode is still experimental -- need to understand pedestal structure, stability against large ELMs to extrapolate to larger devices, develop for high-performance ``toolkit''
...
\begin{frame}{Coupled peeling-ballooning MHD modes\\ calculated by ELITE code}
